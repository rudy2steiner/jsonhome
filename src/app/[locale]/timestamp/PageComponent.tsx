    ...
    <ScWrapper>
            ...
            <ScInner>
              ...
              <ScMain>
                ...
                <ScSelectWrapper >
                  <ScAction className="text-center" >Pick date</ScAction>
                  <div className="flex justify-between ">
                  <Picker<Moment>
                    {...sharedProps}
                    locale={zhCN}
                ...
                <ScCopyright>Made by <a href="https://jsonhome.com">Rudy Steiner</a></ScCopyright>
                <ScSponsor>
                  <a href="https://buymeacoffee.com/jsonhome" target="_blank">
                  ...
                  <a href="https://twitter.com/jsonhome" target='_blank'>
                  ...
                  <a href='https://github.com/jsonhome/timestamps' target='_blank'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
