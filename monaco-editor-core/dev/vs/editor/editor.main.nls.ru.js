...
define("vs/editor/editor.main.nls.ru", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Не показывать значок ИИ.",
		"Показывать значок ИИ, когда меню действия кода содержит действие ИИ, но только в коде.",
		"Показывать значок ИИ, когда меню действия кода содержит действие ИИ в коде и пустых строках.",
		"Показывать значок ИИ вместе с лампочкой, когда меню действия кода содержит действие ИИ.",
		...
		"Определяет, можете ли вы перетащить файл в текстовый редактор, удерживая клавишу \"SРHIFT\" (вместо открытия файла в редакторе).",
	...
	"vs/editor/contrib/codeAction/browser/lightBulbWidget": [
		...
		"Запустить встроенный чат ({0})",
		"Запустить встроенный чат",
		"Активировать действие ИИ",
	],
